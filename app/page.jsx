...
const countries = [
  { ru: "Армения", en: "Armenia", code: "AM", fiat: "AMD", markup: 1.023 },
  { ru: "Беларусь", en: "Belarus", code: "BY", fiat: "BYN", markup: 1.026 },
  { ru: "Индия", en: "India", code: "IN", fiat: "INR", markup: 1.021 },
  { ru: "Индонезия", en: "Indonesia", code: "ID", fiat: "IDR", markup: 1.024 },
  { ru: "Казахстан", en: "Kazakhstan", code: "KZ", fiat: "KZT", markup: 1.028 },
  { ru: "Кыргызстан", en: "Kyrgyzstan", code: "KG", fiat: "KGS", markup: 1.025 },
  { ru: "ОАЭ", en: "UAE", code: "AE", fiat: "AED", markup: 1.02 },
  { ru: "Россия", en: "Russia", code: "RU", fiat: "RUB", markup: 1.027 },
  { ru: "Таиланд", en: "Thailand", code: "TH", fiat: "THB", markup: 1.022 },
  { ru: "Узбекистан", en: "Uzbekistan", code: "UZ", fiat: "UZS", markup: 1.03 },
];

const countryCities = {
  AE: ["Абу-Даби", "Дубай"],
  AM: ["Ереван"],
  BY: ["Брест", "Витебск", "Гомель", "Гродно", "Минск", "Могилёв"],
  ID: ["Бали", "Джакарта", "Сурабая"],
  IN: ["Бангалор", "Дели", "Колката", "Мумбаи", "Ченнаи"],
  KG: ["Бишкек"],
  KZ: ["Актобе", "Алматы", "Астана", "Атырау", "Караганда", "Павлодар", "Семей", "Тараз", "Усть-Каменогорск", "Шымкент"],
  RU: [
    "Великий Новгород",
    "Вологда",
    "Волгоград",
...
const countryCitiesEn = {
  ...
  KG: ["Bishkek"],
  AE: ["Abu Dhabi", "Dubai"],
  TH: ["Bangkok", "Pattaya", "Phuket"],
  UZ: ["Namangan", "Tashkent"],
};
...
const activeMapCountries = [
  ...
  { code: "IN", names: ["India"] },
  { code: "ID", names: ["Indonesia", "Republic of Indonesia"] },
...
const content = {
  ru: {
    nav: ["Обмен", "Как проходит", "Страны", "Преимущества", "Отзывы", "FAQ"],
    ...
    country: "Страна обмена",
    give: "Вы отдаёте",
    receive: "Вы получаете",
    submit: "Зафиксировать курс",
    stepsTitle: "Как проходит обмен",
    benefitsTitle: "Почему выбирают Token Cash",
    countriesTitle: "География Token Cash",
    countriesText: "Работаем по заявке в 10 странах. Выберите страну, валюту и свяжитесь с менеджером.",
    countryList: "Страны присутствия",
    reviewsTitle: "Отзывы клиентов",
    faqTitle: "Вопросы и ответы",
    finalTitle: "Готовы совершить обмен?",
    finalText: "Напишите менеджеру Token Cash — согласуем страну, сумму, направление и удобное время сделки.",
    steps: [
      ["01", "Оставьте заявку", "Выберите страну, направление обмена и сумму. Затем напишите менеджеру в Telegram."],
    ...
    faq: [
      ...
      ["Какие страны доступны?", "Армения, Беларусь, Индия, Индонезия, Казахстан, Кыргызстан, ОАЭ, Россия, Таиланд и Узбекистан."],
      ["Какие валюты поддерживаются?", "Фиат: AED, AMD, BYN, IDR, INR, KGS, KZT, RUB, THB, UZS. Крипта: USDT, BTC, ETH, BNB, SOL, USDC."],
    ],
  },
  en: {
    nav: ["Exchange", "Process", "Countries", "Benefits", "Reviews", "FAQ"],
    links: ["#exchange", "#steps", "#countries", "#benefits", "#reviews", "#faq"],
    contact: "Contacts",
    title: "Crypto exchange in office",
    subtitle: "Best rates for new and returning clients, with worldwide cash payouts. Rare currencies are available by prior arrangement.",
    ...
    countriesTitle: "Token Cash coverage",
    countriesText: "We work by request in 10 countries. Select a country, currency and contact a manager.",
    countryList: "Available countries",
    reviewsTitle: "Client reviews",
    faqTitle: "Questions and answers",
    finalTitle: "Ready to exchange?",
    finalText: "Contact Token Cash manager — we will confirm country, amount, direction and visit time.",
    steps: [
      ["01", "Submit request", "Choose country, exchange direction and amount. Then contact a manager on Telegram."],
    ...
    faq: [
      ...
      ["Which countries are available?", "Armenia, Belarus, India, Indonesia, Kazakhstan, Kyrgyzstan, UAE, Russia, Thailand and Uzbekistan."],
      ["Which currencies are supported?", "Fiat: AED, AMD, BYN, IDR, INR, KGS, KZT, RUB, THB, UZS. Crypto: USDT, BTC, ETH, BNB, SOL, USDC."],
    ],
  },
};
